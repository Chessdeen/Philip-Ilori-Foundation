...
$page = isset($_GET['menu'])?$_GET['menu']:'user_registration';
...
<main data-brackets-id='859' data-brackets-id='492' role="main">
  ...
  <section data-brackets-id='860' data-brackets-id='493' class="jumbotron text-center">
    <div data-brackets-id='861' data-brackets-id='494' class="container">
      <h1 data-brackets-id='862' data-brackets-id='495' class="jumbotron-heading">Register</h1>
 ...
 <div class="col-lg-7 mb-5 text-center" >
         <form role="form" action="registration.php" method="post" id="login_form" autocomplete="off">
             

              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" name="username" class="form-control" placeholder="Enter Desired Username" autocomplete="on" value="<?php echo isset($username) ? $username : '' ?>">
                ...
                <p>&nbsp;</p>
                <div class="col-md-12">
                  <input type="email" name="email" class="form-control" placeholder="somebody@example.com" autocomplete="on" value="<?php echo isset($email) ? $email : '' ?>">
              ...
              <div class="form-group row">
                <div class="col-md-12 mr-auto">
                  <input type="submit" name="register" class="btn btn-block btn-primary text-white py-3 px-5 rounded-0" value="Register">
                </div>
              </div>
            </form>
          </div>
